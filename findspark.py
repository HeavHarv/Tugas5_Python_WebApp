...
os.environ["SPARK_HOME"] ="/home/HeavHarv/spark-3.1.2-bin-hadoop3.2/"
...
def find():
    ...
    if not spark_home:
        for path in [
            ...
            "/home/HeavHarv/spark-3.1.2-bin-hadoop3.2/",
...
def init(spark_home=None, python_path=None, edit_rc=False, edit_profile=False):
    ...
    # spark_home = "/home/imamcs/spark-3.1.2-bin-hadoop3.2"
    # # python_path = "/home/imamcs/spark-3.1.2-bin-hadoop3.2/python/:/home/imamcs/spark-3.1.2-bin-hadoop3.2/python/lib/py4j-0.10.9-src.zip"
    # python_path = "/home/imamcs/spark-3.1.2-bin-hadoop3.2/python/lib/py4j-0.10.9-src.zip:/home/imamcs/spark-3.1.2-bin-hadoop3.2/python/"
    ...
    try:
        ...
        # py4j = glob(os.path.join(spark_python, "lib", "py4j-0.10.9-src.zip"))[0]
        # py4j = "/home/imamcs/spark-3.1.2-bin-hadoop3.2/python/lib/py4j-0.10.9-src.zip:/home/imamcs/spark-3.1.2-bin-hadoop3.2/python/"
